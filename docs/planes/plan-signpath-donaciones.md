...
- [ ] **OSS-03:** resolver específicamente Oracle, Db2 y JDBC de Informix. [Respuesta recibida el 16 de septiembre](../distribucion/consulta-signpath-borrador.md): probablemente deben excluirse de la edición candidata salvo excepción demostrada; una edición separada y funcional sin ellos podría evaluarse. Falta decidir e implementar ese alcance y aclarar SNI/WebView2. No asumir que descargar el controlador aparte resuelve la elegibilidad del proyecto.
