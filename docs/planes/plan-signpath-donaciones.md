...
Validación del bloque Rust/actualizaciones: [PR #25 integrado, instaladores y hashes comprobados](../revisiones/avisos-rust-actualizaciones-2026-09-22.md). CI de Comunidad satisfactoria; 165 textos Rust y nueve nativos incluidos; firma local del actualizador válida. Preparado respaldo local de 307 crates. No se publicó una actualización ni se cerraron revisión de fuente correspondiente, Windows limpio o SignPath.

Continuación del 22 de septiembre: incorporados los [avisos de 238 crates Rust](../terceros/comunidad-rust/README.md), SDK/loader WebView2, NSIS y su complemento Tauri, con guardas de hashes y versiones. Preparado el [canal de actualización de Comunidad](../distribucion/actualizaciones-comunidad.md) en el flujo de las tres ediciones, con verificaciones de firma, URL e inventario y CI de Comunidad para el commit exacto. La implementación no activa una release pública ni cierra fuente correspondiente, código generado, Windows limpio o admisión de SignPath.
