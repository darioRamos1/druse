...
Estado al 13 de septiembre de 2026: propuesta para revisión del titular. **No hay un perfil de cobro verificado ni enlaces de pago activos en este documento.**
...
Revisión del 13 de septiembre de 2026. **El gasto monetario comprobado hoy es cero.** Todo lo que Druse consume ahora mismo son recursos del equipo del mantenedor y servicios gratuitos, y uno de ellos ni siquiera está funcionando.

| Concepto | Gasto comprobado | Qué se sabe | Qué haría falta |
| --- | --- | --- | --- |
| Integración continua | US$0, y **sin ejecutar** | La última ejecución de CI (12 de septiembre de 2026, run `34726580535`) terminó en fallo a los pocos segundos con sus **quince trabajos sin ejecutar un solo paso**. Las anteriores, igual. El síntoma coincide con un bloqueo de facturación de Actions; con el token disponible no se puede leer la facturación de la cuenta para confirmarlo | Resolver el bloqueo antes de depender de CI para una release. Un repositorio público usa runners estándar sin coste; uno privado consume la cuota del plan, y los minutos de Windows y macOS cuentan multiplicados. [Facturación de Actions](https://docs.github.com/en/billing/managing-billing-for-your-products/managing-billing-for-github-actions/about-billing-for-github-actions) |
...
**Prioridad de los aportes, si llegan:** primero lo que sostiene la corrección de errores —poder ejecutar CI y probar en un equipo limpio—, después el mantenimiento y la compatibilidad de motores. Ninguna función nueva depende de que alguien aporte.
